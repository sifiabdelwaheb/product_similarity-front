...
module.exports = {
  ...
  'user.login-button': 'Einloggen',
  'user.register-button': 'Registrieren',
  'user.reset-password-button': 'REINICIAR',
  'user.buy': 'COMPRAR',
  'user.username': 'Benutzername',
  'user.new-password-again': 'Neues Passwort nochmal',
  ...
  'menu.pages': 'Páginas',
  'menu.users': 'Unternehmen',
  'menu.packages': 'Pack',
  'menu.employee': 'Mitarbeiter',
  'menu.incapacity': 'Unfähigkeit',
  ...
  'dashboards.users': 'Unternehmen',
  'dashboards.pack': 'pack',
  'dashboards.employee': 'Mitarbeiter',
  'dashboards.incapacity': 'Unfähigkeit',
  ...
  /* 05.Esquemas */
  'pages.add-new': 'NEU HINZUFÜGEN',
  'pages.add-new-modal-title': 'Neuen Artikel hinzufügen',
  ...
  'table.react-advanced': 'Filter, Länge und Sprung',
  ...
  // Page  packages\
  'Home.packageOne': 'Paket eins',
  'Home.packageTwo': 'Paket zwei',
  'Dashbord.packages': 'Packages',
  'Pack.name': 'Name',
  'Pack.description': 'Beschreibung',
  'Pack.price': 'Preis',
  'Pack.edit': 'Bearbeiten',
  'Pack.delete': 'Löschen',
  'Pack.beginDate': 'Startdatum',
  'Pack.endDate': 'Enddatum',
  'Pack._id': 'id',
  'pack.showInHomePage': 'In Homepage anzeigen',
  'Pack.showInHomePage': 'In Homepage anzeigen',
  'Pack.image': 'Bild',
  'form-components.date': 'Datum',
  'pack.true': 'Ja',
  'pack.false': 'Nein',
  ...
  //Page Users
  'users.reseller': 'Wiederverkäufer',
  'users.consumer': 'Verbraucher',
  'users.details': 'Einzelheiten',
  'users.logo': 'Logo',
  'users.theme': 'Thema',
  ...
  'users.confirmPassword': 'Kennwort bestätigen',
  ...
  Password: 'Passwort',
  'E-mail': 'E-mail',
  'user.confirmPassword': 'Kennwort bestätigen',
  'user.reseller': 'Wiederverkäufer',
  //Page  employee
  ...
  'employee.code': 'Code',
  'employee.priorNotice': 'Vorankündigung',
  'employee.beginDateRestitution': 'Beginn der Rückgabe',
  'employee.beginDateContract': 'Datenvertrag beginnen',
  'employee.nbDaysLeaveRestitution': 'Nb Tage Urlaubsrückerstattung',
  'employee.status': 'Status',
  'employee.edit': 'Bearbeiten',
  'employee.delete': 'Löschen',
  'active': 'Aktiv',
  ...
  'user.code': 'Code',
  'user.priorNotice': 'Vorankündigung',
  'user.beginDateRestitution': 'Beginn der Rückgabe',
  'user.beginDateContract': 'Datenvertrag beginnen',
  'user.nbDaysLeaveRestitution': 'Nb Tage Urlaubsrückerstattung',
  'user.status': 'Status',
  'emploiyee.preview': 'Vorschau',

  //Page  incapacity
  'incapacity.code': 'Code',
  'incapacity.name': 'Name',
  'incapacity.description': 'Beschreibung',
  'incapacity.edit': 'Bearbeiten',
  'incapacity.delete': 'Löschen',
  'incapacity.preview': 'Vorschau',
  ...
  'input.invalid': 'Erforderlich',

  //component Topanv

  'topnav.signout': 'Ausloggen',
  'topnav.account': 'Konto',
  'topnav.features': 'Eigenschaften',
  'topnav.history': 'Geschichte',
  'topnav.support': 'Unterstützung',

  //modal title
  'modaltitle.pack': 'Neues Pack hinzufügen',
  'modaltitle.users': 'Neues Unternehmen hinzufügen',
  'modaltitle.employee': 'Neuen Mitarbeiter hinzufügen',
  'modaltitle.incapacity': 'Neue Arbeitsunfähigkeit hinzufügen',
  'modaledit.pack': 'Neues Pack bearbeiten',
  'modaledit.users': 'Neue Firma bearbeiten',
  'modaledit.employee': 'Neuen Mitarbeiter bearbeiten',
  'modaledit.incapacity': 'Neue Arbeitsunfähigkeit bearbeiten',
  'modalpreview.pack': 'Vorschau des neuen Pakets',
  'modalpreview.incapacity': 'Vorschau neuer Unfähigkeit',
  'modalpreview.employee': 'Vorschau des neuen Mitarbeiters',
  'modalpreview.users': 'Vorschau der neuen Firma',

  //form employeeincapacity
  'user.IncapacityName': 'Name der Arbeitsunfähigkeit',
  'user.Details': 'Einzelheiten',
  type: 'Typ',
  ...
  Delete: 'Löschen',
  Preview: 'Vorschau',
  Incapacitys: 'Unfähigkeit',

  //employee previewmodal
  'previewmodal.code': 'Code',
  'previewmodal.name': 'Name',

  'previewmodal.beginDate': 'Startdatum',
  'previewmodal.endDate': 'Endtermin',
  'previewmodal.details': 'Einzelheiten',
  'previewmodal.addrelapse': 'Neuen Rückfall hinzufügen',
  'previewmodal.editrelapse': 'neuen Rückfall bearbeiten',
  'previewmodal.relapse': 'Rückfall',
  'global.informations': 'Informationen',
  'global.results': 'Ergebnisse',
