...
module.exports = {
  ...
  // Page home packages\
  // Page home packages\
  'Home.packageOne': 'Package one',
  'Home.packageTwo': 'Package two',
  ...
  'Pack.edit': 'Edit',
  'Pack.delete': 'Delete',
  'Pack.beginDate': 'Begin date',
  'Pack.endDate': 'End date',
  'Pack._id': 'id',
  'Pack.showInHomePage': 'Show In Home Page',
  'pack.showInHomePage': 'show In Home Page',
  'Pack.image': 'Image',
  'pack.true': 'Yes',
  'pack.false': 'No',
  ...
  'employee.code': 'Code',
  'employee.priorNotice': 'Prior Notice',
  'employee.beginDateRestitution': 'Begin Date Restitution',
  'employee.beginDateContract': 'Begin Date Contract',
  'employee.nbDaysLeaveRestitution': 'Nb Days Leave Restitution',
  ...
  'user.code': 'Code',
  'user.priorNotice': 'Prior Notice',
  'user.beginDateRestitution': 'Begin Date Restitution',
  'user.beginDateContract': 'Begin Date Contract',
  'user.nbDaysLeaveRestitution': 'Nb Days Leave Restitution',
  'user.status': 'Status',
  ...
  'incapacity.edit': 'Edit',
  'incapacity.delete': 'Delete',
  'incapacity.preview': 'Preview',
  ...
  //modal title
  'modaltitle.pack': 'Add new Pack',
  'modaltitle.users': 'Add new Entreprise',
  'modaltitle.employee': 'Add new Employee',
  'modaltitle.incapacity': 'Add new Incapacity',
  'modaledit.pack': 'Edit new Pack',
  'modaledit.users': 'Edit new Entreprise',
  'modaledit.employee': 'Edit new Employee',
  'modaledit.incapacity': 'Edit new Incapacity',
  'modalpreview.pack': 'Preview new Pack',
  'modalpreview.incapacity': 'Preview new Incapacity',
  'modalpreview.employee': 'Preview new Employee',
  'modalpreview.users': 'Preview new Entreprise',

  //form employeeincapacity
  'user.IncapacityName': 'Incapacity Name',
  ...
  Delete: 'Delete',
  Preview: 'Preview',
  Incapacitys: 'Incapacitys',
  beginDateRestitution: 'Begin Date Restitution',

  //employee previewmodal
  'previewmodal.code': 'Code',
  'previewmodal.name': 'Name',

  'previewmodal.beginDate': 'Begin date',
  'previewmodal.endDate': 'End Date',
  'previewmodal.details': 'Details',
  'previewmodal.addrelapse': 'Add New Relapse',
  'previewmodal.relapse': 'Relapse',

  //modal message delete
  deletemessage: 'Are you sure you wanna delete!',
  'modal.cancel': 'cancel',
  cancel: 'Cancel',
  Envoyée: 'Submit',
